...
**Thanks to [Erich](https://t.me/moviessearch_box) and his [InFoTel](https://t.me/moviessearch_box) for this Video**
...
#### Deploy in your VPS
````bash
git clone https://github.com/maanboy/File-Sharing-Bot
cd File-Sharing-Bot
